...
class PesananController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
            $model->t_date_created=strtotime(date($_POST['Pesanan']['date_created']));
			$model->attributes=$_POST['Pesanan'];
			if($model->save())
				$this->redirect(array('view','id'=>$model->id_pesanan));
		}
	...
	{
		$dataProvider=new CActiveDataProvider('Pesanan');
	 ...
	 * @param Pesanan $model the model to be validated
	 */
