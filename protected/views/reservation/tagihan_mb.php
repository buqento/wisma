...
<table class="table table-bordered">
    ...
    <tr>
        ...
        <?php if($jenis_sewa == 'mingguan'){ ?>
            <th>
                <?php echo "Tarif Sewa Kamar @".number_format($tarif,0,',','.').".- Selama (".$jminggu.") Minggu";?>
            </th>
        <?php }else{ ?>
            <th>
                <?php echo "Tarif Sewa Kamar @".number_format($tarif,0,',','.').".- Selama (".$jmonth.") Bulan";?>
            </th>
        <?php }?>
        <td><p class="text-right"><?php echo number_format($tbayar,0,',','.').".-";?></p></td>
    </tr>
