...
class TipeKamar extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('tipe_kamar, harga', 'required'),
			array('harga', 'numerical', 'integerOnly'=>true),
			array('tipe_kamar', 'length', 'max'=>30),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_tipe, tipe_kamar, harga', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('tipe_kamar',$this->tipe_kamar,true);
